...
distribution runs as the delivery pipeline stands up, the road cosmic
and the-cumdach travel. Tone changes happen in the water; the chime
is opt-in in the time-room, silence the default a hand chose.

Record: docs/CHECKLIST.md (THE CARE).
