...
As of 2026-08-06 (the Cumdach consumption - the care's first spring
...
file: link: Compass is a standalone, given-away-whole repo - a link
reaching outside it would break a lone clone's build; the mirror
keeps Compass sovereign.

Record: docs/CHECKLIST.md (THE CARE) + docs/THE-UX-WALK.md.
