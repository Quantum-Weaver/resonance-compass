// QUANTUM TYPOGRAPHY SYSTEM — derived from dimensions.ts. Font families, sizes,
// weights, and semantic text styles. Compatible with Tailwind CSS v4 and Framer Motion.
