// GENERATED by the-lexicon (resonance-awen/tools/the-lexicon) — never hand-edit.
// Canon: the Grammar base's thesaurus, folksonomy 'Compass'.
// Heal by regenerating: the-lexicon Compass --out <this file>
...
export const EMOJI_DEFS: EmojiDef[] = [
  {
    ...
    "sensory": {
      "color": "soft lavender",
      "sound": "low hum of a distant fan",
      "texture": "warm fleece",
  ...
  },
  {
    ...
    "sensory": {
      ...
      "texture": "sunlit surface",
      "temperature": "gentle warmth"
    }
  },
  {
    "emoji": "🌙",
    ...
    "sensory": {
      "color": "grey-blue moonlight",
      "sound": "silence between notes",
      "texture": "cold stone",
  ...
  },
  {
    ...
    "sensory": {
      "color": "blinking static",
      "sound": "overlapping voices",
      "texture": "buzzing surface",
      "temperature": "uneven"
    }
  },
  {
  ...
  },
  {
    ...
    "sensory": {
      "color": "soft grey",
      "sound": "slow breathing",
      "texture": "heavy blanket",
  ...
  },
  {
    ...
    "sensory": {
      ...
      "sound": "ringing silence",
      "texture": "weightless",
      "temperature": "neither warm nor cold"
    }
  }
];
