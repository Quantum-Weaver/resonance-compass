...
| U3 | 2026-08-05 | (standing note, 07-19) the sidebar should have a **Studio** button; empty states should INVITE ("play a song to create a fragment from") — doorways, not dead ends | — | ⬜ open |
